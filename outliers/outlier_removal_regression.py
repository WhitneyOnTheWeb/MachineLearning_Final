...
if len(cleaned_data) > 0:
    ...
    print('Slope (No Outliers): ', reg.coef_)
    print('Intercept (No Outliers): ', reg.intercept_)
    print('R^2 Score (No Outliers): ', reg.score(ages_test, net_worths_test))
    plt.scatter(ages, net_worths, color=train_color, label="train")
    plt.xlabel("ages")
